      ...
      <div className="container">
        <div className="generator">
          ...
          <div className="form-group">
            ...
            <input className="pw" defaultValue={passwordLength} onChange={(e) => setPasswordLength(e.target.value)} type="range" id="password-stregth" name="password-strength" max="12" min="8" />
          </div>
          <div className="form-group">
